...
export default function FoodParty(){
    return(
        <div className="container-fluid mt-5">
            <div className={clsx("container-fluid flex-row-reverse d-flex  align-items-center text-white px-4" , style.partyContainer)}>
                <div className={clsx(style.partyDetail , "d-flex flex-column ms-5  justify-content-center align-items-center")}>
                    <h4 className="my-5">
